...
const DataTableMaterialRequirementForm = memo(({ data = [], columns = [], resourceTitle }) => {
    return (
...
DataTableMaterialRequirementForm.displayName = 'DataTableMaterialRequirementForm';

export default DataTableMaterialRequirementForm;
