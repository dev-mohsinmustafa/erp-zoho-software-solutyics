...
const DataTableSalesCustomers = memo(({ data = [], columns = [], resourceTitle }) => {
...
DataTableSalesCustomers.displayName = 'DataTableSalesCustomers';

export default DataTableSalesCustomers;