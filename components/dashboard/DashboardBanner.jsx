    ...
    return (
        <div className={`${hidden ? "hidden" : "hidden lg:grid grid-cols-12 items-center py-6 px-16 bg-white gap-4 relative"}`}>
            ...
            <div className='col-span-6'>
                ...
                <p>Businesses are moving toward online payments as they're easy, secure and fast. Try them for your business today.</p>
            </div>
            {/* Button */}
            <div className='col-span-3'>
                <button className='py-2 px-8 uppercase bg-blue-500 text-white text-sm rounded-2xl'>
                    Enable
                </button>
            </div>
            {/* Close Button */}
