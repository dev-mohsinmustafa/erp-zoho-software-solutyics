...
const DataTablePointofSales = memo(({ data = [], columns = [], resourceTitle }) => {
    ...
    const handleMarkAsPaid = async (id) => {
        try {
            const response = await fetch(`/api/pos/point-of-sales/${id}`, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                },
                                                        ...
                                                        <td key={index} className="px-6 py-4">
                                                            {columnName.includes(".") ?
                                                                (columnName === "customer.name" ?
                                                                    (item.customer?.name || "No Customer (Walk-in)") :
                                                                ...
                                                                columnName === "imageUrl" ?
                                                                    ...
                                                                    :
                                                                    columnName === "createdAt" || columnName === "updatedAt" || columnName === "invoiceDate" || columnName === "dueDate" || columnName === "transactionDate"
                                                                        ?
                                                                        (
...
DataTablePointofSales.displayName = 'DataTablePointofSales';

export default DataTablePointofSales;