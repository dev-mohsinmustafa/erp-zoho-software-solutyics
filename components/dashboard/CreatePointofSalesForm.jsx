...
const CreatePointofSalesForm = ({ items, initialData = {}, isUpdate = false }) => {
    ...
    function redirect() {
        router.push("/dashboard/pos/point-of-sales");
    }

    async function onSubmit(data) {
        if (isUpdate) {
            makePutRequest(setLoading, `/api/pos/point-of-sales/${initialData.id}`, data, "Point of Sale", reset, redirect);
        } else {
            makePostRequest(setLoading, "/api/pos/point-of-sales", data, "Point of Sale", reset);
        }
    }
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                            The transaction date is recorded for your sales records and appears in reports. Since POS transactions are paid immediately, no payment due date is required. All payments are settled at the time of purchase.
                        </p>
                        <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div className="mt-6">
                    <SubmitButton title={isUpdate ? "Update Point of Sale" : "Create Point of Sale"} isLoading={loading} />
                </div>
            </form>
        </div>
    );
...
export default CreatePointofSalesForm;
