...
const DataTableTaxes = memo(({ data = [], columns = [], resourceTitle }) => {
                                                            ...
                                                            {columnName.includes(".") ?
                                                                ...
                                                                columnName === "imageUrl" ?
                                                                    ...
                                                                    columnName === "createdAt" || columnName === "updatedAt" || columnName === "saleDate"
                                                                        ...
                                                                        :
                                                                        // Add this new condition for boolean values
...
DataTableTaxes.displayName = 'DataTableTaxes';

export default DataTableTaxes;