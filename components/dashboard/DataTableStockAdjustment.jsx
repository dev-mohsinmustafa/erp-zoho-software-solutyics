...
const DataTableStockAdjustment = memo(({ data = [], columns = [], resourceTitle }) => {
...
DataTableStockAdjustment.displayName = 'DataTableStockAdjustment';

export default DataTableStockAdjustment;