...
const DataTablePurchasesPayments = memo(({ data = [], columns = [], resourceTitle }) => {
...
DataTablePurchasesPayments.displayName = 'DataTablePurchasesPayments';

export default DataTablePurchasesPayments;